-- ================================================================
-- SCRIPT CONSOLIDADO DE LIMPIEZA PARA LOGGER CON COLA JMS
-- ================================================================
...
-- Configuracion especifica de cola JMS
DEFINE NOMBRE_COLA_LOG = "log_execution_queue";
DEFINE NOMBRE_TABLA_COLA = "log_queue_table";
DEFINE TIPO_MENSAJE_LOG = "t_log_message";
